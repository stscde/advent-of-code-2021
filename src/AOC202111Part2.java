...
/**
 * Advent of Code 2021/12/11 Part 2<br>
 */
public class AOC202111Part2 {

	public static void main(String[] args) throws IOException {

		// read input
		BufferedReader br = new BufferedReader(new InputStreamReader(AOC202111Part2.class.getResourceAsStream("AOC202111_input.txt")));
		String line = null;
		...
		for (int s = 0; s < Integer.MAX_VALUE; s++) {
			...
			// check if all flashed and power down octos
			...
			for (int y = 0; y < pMap.length; y++) {
				for (int x = 0; x < pMap[y].length; x++) {
					...
					System.out.print(fMap[x][y]);
				}
				System.out.println();
			}

			if (allFlashed) {
				System.out.println("all octos flashed in step: " + (s+1));
				System.exit(0);
			}
